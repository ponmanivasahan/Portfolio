...
const achievements=[{
  title:"2x National Hackathon Winner", description:"Won first place at two national-level hackathons competing against 500+ teams, building innovative solutions for real-worls problems.", icon:Trophy, highlight:true
},
{
...
{
  title:"Top 30% on LeetCode", description:"Consistency ranked in the top 30% of the LeetCode users with 500+ problems solve across all difficulty levels.",icon:Star
},
...
const Achievements = () => {
  return (
    <section id="achievements" className="section-gradient relative">
      ...
      <div className="mx-aut max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        ...
        <h2 className="mb-3 text-2xl font-bold text-foreground sm:text-3xl md:text-5xl">Milestones & Recogination</h2>
        <p className="mb-10 max-w-2xl text-sm text-muted-foreground  sm:mb-12 sm:text-base">
          Key accomplishments and recoginations throughout my journey as a developer.
        </p>
          ...
          {achievements.map((ach)=>{
            ...
            return(
              <div key={ach.title} className={`card-elevated group p-4 sm:p-6 ${ach.highlight ? "border-foreground/15" : ""}`}>
                ...
                <h3 className="mb-2 text-sm font-semibold text-foreground dm:text-base">
                  {ach.title}
                </h3>
